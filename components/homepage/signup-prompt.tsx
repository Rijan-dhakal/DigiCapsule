      ...
      <div className="w-full bg-gray-800 rounded-md">
        <div className="p-8 text-center">
          ...
          <p className=" mt-2 text-sm leading-relaxed text-white/60">
            Start creating your memory today. It's free to create your first
            capsule.
          </p>

          <div className="text-center px-5 mt-5">
            <Button asChild className="font-semibold cursor-pointer w-full md:max-w-fit md:px-4 md:py-2">
